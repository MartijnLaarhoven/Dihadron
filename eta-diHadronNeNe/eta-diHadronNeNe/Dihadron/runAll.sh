...
root -q -l -b Process_PeripheralSubtraction.cxx
root -q -l -b Process_CreateBootstrapSample_PeripheralSubtracted.cxx
root -q -l -b Process_TemplateFit_PeripheralSubtracted.cxx
